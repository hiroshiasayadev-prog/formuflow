...
| `docs/spec/01-layout.md` | confirmed | ❌ 未追加 |
| `docs/spec/02-flow-canvas.md` | confirmed | ❌ 未追加 |
| `docs/spec/03-component-nodes.md` | confirmed | ❌ 未追加 |
| `docs/spec/04-sidebar.md` | confirmed | ❌ 未追加 |
| `docs/spec/05-tabs-navigation.md` | confirmed | ❌ 未追加 |
| `docs/spec/06-formula-editor.md` | confirmed | ❌ 未追加 |
